...
@Service
public class CostsWriteOffWarehouseOperationProcessor extends AbstractWarehouseOperationProcessor {

    public CostsWriteOffWarehouseOperationProcessor(WarehouseOperationRepository opres) {
        super(opres);
    }
    @Override
    ...
    public WarehouseOperationType supportedType() {
        return WarehouseOperationType.COSTS_WRITE_OFF;
    }
