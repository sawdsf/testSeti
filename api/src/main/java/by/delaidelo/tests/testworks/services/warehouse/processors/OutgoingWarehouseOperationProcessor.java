...
@Service
public class OutgoingWarehouseOperationProcessor extends AbstractWarehouseOperationProcessor {
    public OutgoingWarehouseOperationProcessor(WarehouseOperationRepository opres) {
        super(opres);
    }
    ...
    public WarehouseOperationType supportedType() {
        return WarehouseOperationType.OUTGOING;
    }
}
